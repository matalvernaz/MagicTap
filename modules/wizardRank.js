...
const WizardRankModule = (function() {
    ...
    const ranks = [
        ...
        { name: 'Plant Magus', minAchievements: 166 },
        { name: 'Mind Magus', minAchievements: 169 },
        { name: 'Metal Magus', minAchievements: 172 },
        { name: 'Solar Magus', minAchievements: 175 },
        { name: 'Lunar Magus', minAchievements: 177 },
        { name: 'Astral Magus', minAchievements: 179 },
        { name: 'Gravity Magus', minAchievements: 181 },
        { name: 'Life Magus', minAchievements: 183 },
        { name: 'Death Magus', minAchievements: 185 },
        { name: 'Light Magus', minAchievements: 186 },
        { name: 'Dark Magus', minAchievements: 187 },
        { name: 'White Magus', minAchievements: 188 },
        { name: 'Black Magus', minAchievements: 189 },
        { name: 'Silver Magus', minAchievements: 190 },
        { name: 'Gold Magus', minAchievements: 191 },
        { name: 'Arch Magus', minAchievements: 192 },
        { name: 'Grand Magus', minAchievements: 193 },
        { name: 'Void Magus', minAchievements: 194 },
        { name: 'Archmage', minAchievements: 195 },
        { name: 'Arcane Weaver', minAchievements: 196 },
        { name: 'Grand Weaver', minAchievements: 197 },
        { name: 'True Weaver', minAchievements: 198 },
        { name: 'Eldritch', minAchievements: 199 },
        { name: 'Deity', minAchievements: 200 },
